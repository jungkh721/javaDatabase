...
public class T06_AbsouluteLayout1 extends Frame implements WindowListener, ActionListener {
	
	public T06_AbsouluteLayout1() {
		designView();
	}
	
	private void designView(){
		setTitle("AWT 프레임(AbsouluteLayout)");
		setLayout(null);
